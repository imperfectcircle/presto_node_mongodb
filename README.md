...
2. Copia il contenuto del file .env.example in un file .env
   ...
   cp .env.example .env
   ```
3. Modificare le variabili d'ambiente nel file .env 
...
<!-- See the [open issues](https://github.com/imperfectcircle/repo_name/issues) for a full list of proposed features (and known issues). -->
